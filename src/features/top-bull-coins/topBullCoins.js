...
const TopBullCoins = () => {
  ...
  const rows = useSelector((state) => state.topBullCoins.entities);
            ...
            >
              <TableCell>
                ...
                <Avatar
                  ...
                  />
                  <Typography variant="inherit" mt={0}>
                    {row.pair}
                  </Typography>
                </Stack>
              </TableCell>
              ...
              <TableCell style={{color:"primary",}}>
                <div style={{
                    ...
                    alignItems: 'center',
                    flexWrap: 'noWrap',
                    color: row.hour === 0  ? 'gray': row.hour > 0 ? 'green' : 'red'
                }}>
                    <Typography variant="inherit">
                      {row.hour}%
                    </Typography>

                    {row.hour === 0  ? (<ArrowUpwardIcon fontSize="x-small" />) :
                      row.hour > 0 ? (<ArrowUpwardIcon fontSize="x-small" />) :
                      (<ArrowDownwardOutlinedIcon fontSize="x-small" />)}
